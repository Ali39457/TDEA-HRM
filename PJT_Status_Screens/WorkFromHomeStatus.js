...
export default function WorkFromHomeStatus() {

    //------------------------DataArray state-------------------------//

    const [DataArray,setDataArray]=useState([
  {key:"1",name:"Muhammad Ali",Type:"Work from Home ",start_date:"29,May,2022",end_date:"29,May,2022",status:"Approved"},
  {key:"2",name:"Muhammad Ali",Type:"Field Visit ",start_date:"29,May,2022",end_date:"30,May,2022",status:"Pending"},
  {key:"3",name:"Muhammad Ali",Type:"Work from Home",start_date:"29,May,2022",end_date:"5,June,2022",status:"Rejected"},
    ])
  
  
    //------------------------getData(DataArray) from Api-------------------------//
     ...
     const getData = async () => {
       ...
       try {
         await AsyncStorage.getItem("@ApiData").then(value=>{if(value!=null){
           ...
           setDataArray((user[0].member_list))
         }})
 ...
 //------------------------renderItem-------------------------//
  ...
  const renderItem=({item})=>{
    return  <View style={styles.maintitle1}>
      ...
      <Text style={styles.textTitle1}>{item.Type}</Text>
      </View>
