...
{/*========================================================================================================
==================== if Director is also Supervisor ======== email==="amjad.shah@tdea.pk"===================
========================================================================================================== */}


{
     (email==="amjad.shah@tdea.pk" || Sup_LeaveData.length!=0)  && (secondary_role==="Supervisor" || Sup_LeaveData.length!=0)  ?
     <FlatList
     data={Sup_LeaveData} 
     style={styles.FlatList0} 
     listKey="1"
...
{
    email==="amjad.shah@tdea.pk" && Dir_LeaveData1.length===0 && Sup_LeaveData.length===0 ?
    <View style={{justifyContent:"center",alignItems:"center"}}>
    <Text style={styles.textFlat3}>Sorry no record found!</Text> 
    </View>
    :null
...
{/*========================================================================================================
============== if Director is also Supervisor ============email==="mud.rizvi@tdea.pk"=======================
========================================================================================================== */}


{
     (email==="mud.rizvi@tdea.pk" || Sup_LeaveData.length!=0)  && (secondary_role==="Supervisor" || Sup_LeaveData.length!=0)  ?
     <FlatList
     data={Sup_LeaveData} 
     style={styles.FlatList0} 
     listKey="1"
...
{
    email==="mud.rizvi@tdea.pk" && Dir_LeaveData2.length===0 && Sup_LeaveData.length===0 ?
    <View style={{justifyContent:"center",alignItems:"center"}}>
    <Text style={styles.textFlat3}>Sorry no record found!</Text> 
    </View>
    :null
...
{
     (email==="ceo@tdea.pk" || Dir_LeaveData3.length!=0)  && (secondary_role==="Supervisor" || Dir_LeaveData3.length!=0)  ?
     <FlatList
     data={Dir_LeaveData3} 
     style={styles.FlatList0} 
     listKey="1"
